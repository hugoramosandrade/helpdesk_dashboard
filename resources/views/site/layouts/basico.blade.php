        ...
        <div class="col-xxl-2 col-xl-4 left-side-bar p-3 bg-dark">
            ...
            <div class="text-center mt-5">
                <form action="">
                    ...
                    <input type="datetime-local" name="data_inicial" id="data_inicial" class="form-control col-12 text-center">
                    <label for="data_final" class="form-label col-12 mt-2 text-light">Data Fim</label>
                    <input type="datetime-local" name="data_final" id="data_final" class="form-control col-12 text-center">
